...
<body>
    ...
    <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Edit Top Player
                        </ol>
                ...
                $result = mysql_query("SELECT * from topplayer where id_player='$_GET[id]'" );
                while($data=mysql_fetch_array($result)){
                    
            ?>   


                      <form  action="edit_topplayer_act.php?id=<?php echo $data['id_player'] ?>" method="post" enctype="multipart/form-data">
