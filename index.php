...
<html>
	<head> 
      ...
      <link rel="stylesheet" type="text/css" href="bootstrap/css/icon-font.min.css">
      <link rel="stylesheet" type="text/css" href="bootstrap/css/bootstrap.min.css">
      <link rel="stylesheet" type="text/css" href="halaman/berita/berita.css">
	</head>
	<body>
...
// When the user clicks on the button, scroll to the top of the document
          ...
          <div class="col-lg-12 col-sm-2 col-xs-12"> 		
    	        <ul class="nav navbar-nav">
    		        <li><a href="index.php">Beranda</a></li>
  			        <li><a href="halaman/pemain.php">Profil Pemain</a></li>
      		      <li><a href="halaman/club.php">Profil Club</a></li>
      		      <li><a href="halaman/galeri.php">Gallery</a></li>
      		      <li><a href="halaman/kontak.php">Contac Us</a></li>
    	        </ul>       
          </div>
        </div>
      </div>
    ...
    <div>
    <p class="teks-hot">Hot News</p>
      
      <?PHP
        require ('halaman/berita/berita.php');
      ?>
