    ...
    <div class="bggaris"></div>
        <div class="container">
            <div style="max-width:100%">
              <?PHP 
                $result = mysql_query("SELECT * FROM profil_club") or die (mysql_error());
                while($data=mysql_fetch_array($result)){
              ?>
              
              <form method="POST" action="">
  <table class="tb-club" align="center" >
      <tr>
        <center><img style="width: 30%" src="../bootstrap/gambar/<?php echo $data['gambar_club']; ?>"></center>
      </tr>
      <tr>
        <th>Nama Club</th>
